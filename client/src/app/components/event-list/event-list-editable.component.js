...
exports.EventListEditableComponent = void 0;
...
var EventListEditableComponent = /** @class */ (function () {
            ...
            switch (action) {
                case confirm_delete_modal_1.EventDeleteAction.DELETE:
                    ...
                    _this.service.deleteEvent(eventWrapper.event)
                        .subscribe(function () {
                        _.remove(_this.allEvents, eventWrapper.event);
                        _.remove(_this.eventWrappers, eventWrapper);
                    }, function (err) {
